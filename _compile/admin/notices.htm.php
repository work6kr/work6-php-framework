<?php /* Template_ 2.2.7 2018/07/05 01:58:52 /volume1/web/lab4.work6.kr/data/skin/admin/notices.htm 000004365 */ ?>
                ...
                <tr>
    				<td>
    					<select name="skey">
    						...
    						<option value="name" <?php echo $TPL_VAR["data"]["selected"]["skey"]["name"]?>>작성자</option>
                            <option value="contents" <?php echo $TPL_VAR["data"]["selected"]["skey"]["contents"]?>>내용</option>
    					</select>
...
<?php if(is_array($TPL_R1=$TPL_VAR["data"]["list"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
                    <tr class="hover_green">
                        ...
                        <td>
<?php if($TPL_V1["file"]){?>
                            <a href="/data/skin/<?php echo $TPL_VAR["cfg"]["skin"]?>/file/<?php echo $TPL_V1["file"]?>" taget="ifrmh">Y</a>
<?php }else{?>
                            N
<?php }?>
                        </td>
						...
						<td><a href="/admin/notice/notice/<?php echo $TPL_V1["idx"]?>">수정</a></td>
					</tr>
<?php }}?>
<?php }else{?>
                    <tr>
